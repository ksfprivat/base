...
//----------------------------------------
    ...
    if (isc.ListGrid) {
        ...
        isc.ListGrid.changeDefaults("operatorIconDefaults", { width: 18, height: 18 });
    ...
    if (isc.DateRangeDialog) {
        ...
        isc.DateRangeDialog.changeDefaults("mainLayoutDefaults", { width: 430 });
    }
    ...
    // force-load the custom fonts declared by @font-face in skin_styles.css
    if (isc.FontLoader) isc.FontLoader.loadCustomFonts([
